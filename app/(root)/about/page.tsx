...
export default function page() {
  return (
    <div className="flex flex-col gap-4 w-full max-w-4xl bg-gray-900 sm:py-12 sm:px-20 p-6 mt-12">
      <h1 className="text-heading1-bold text-light-1 border-b-2 border-zinc-600 pb-2">About SonarMeta</h1>
      <p className="text-light-2">
        🤩🤩🤩 Welcome to SonarMeta, the on-chain angel nurturing and authorization network for emerging IPs. This doc
        will help you know further about us.
      </p>
      ...
      <p className="text-slate-400">We established a Web3 value network.</p>
      <h3 className="text-body-bold text-light-2">Networking protocol</h3>
      ...
      <h3 className="text-body-bold text-light-2 mt-2">Structure of each node</h3>
      <ul className="list-disc text-slate-400">
        <li>
