    ...
    <>
      ...
      <div className="md:basis-1/2 basis-full px-6 py-12">
        <div className="mb-8">
          ...
          <p className="mt-3 text-base-regular text-zinc-700">Join the decentralized IP network today!</p>
          <Link className="text-base-regular text-violet-700 hover:text-violet-600 duration-200" href="/sign-up">
            Have no account?
          </Link>
        </div>
